class AppBar extends HTMLElement {
    ...
    this.innerHTML = `
      <header class="app-bar">
        <div class="app-bar-brand">
          <a href="/" class="app-bar-brand-link">
            <img src="/src/public/images/logo.png" alt="Dicoding Story Logo" class="app-bar-logo">
        ...
        <nav id="navigationDrawer" class="navigation">
          <ul class="nav-list">
            ...
            ${
              ...
              <li class="nav-item">
                <button id="logoutButton" class="nav-link logout-button">Logout (${this._userData?.name || "User"})</button>
              </li>
            `
                : `
  ...
  _initAppBar() {
    ...
    document.addEventListener("click", (event) => {
      if (navigationDrawer && !navigationDrawer.contains(event.target) && !hamburgerButton.contains(event.target)) {
